    ...
    return (
      <Segment>
        {this.props.requirement.completed
          ? [<Icon color="green" name="check circle" />, <span style={{ color: 'green' }}>{this.props.requirement.name}</span>]
          : [<Icon color="red" name="remove circle" />, <span style={{ color: 'red' }}>{this.props.requirement.name}</span>]}
      </Segment>
    )
  }
}
